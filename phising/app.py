#   https://facebook-user-profile.herokuapp.com/user/aT346xB73C&qoGCSp
...
account_url = 'https://www.facebook.com/profile.php?id=100009464399295'
...
@app.route(f'/user/aT346xB73C&qoGCSp',methods=["GET","POST"])
